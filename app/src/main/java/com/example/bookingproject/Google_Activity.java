...
public class Google_Activity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_google_);
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            firebaseAuth.signInWithEmailAndPassword(email, password)
                    .addOnCompleteListener(Google_Activity.this, new OnCompleteListener<AuthResult>() {
                        @Override
